<template>
  ...
  >
    ...
    <div class="space-y-2 flex-auto">
      <h2 class="text-xl text-gray-900">{{ product.name }}</h2>
    ...
    <div class="flex items-center gap-3">
      <RouterLink
        :to="{
          ...
          query: { action: 'edit', product: product.name },
        }"
        @click="productsStore.changeProduct(product)"
      >
        <svg
...
import { ProductFirebase } from "@/entitis/entitis";
